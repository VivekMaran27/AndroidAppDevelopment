...
public class FlowTextHelper {
    ...
    public static void tryFlowText(String text, View thumbnailView, TextView messageView, Display display){
        ...
        if(!mNewClassAvailable)
            System.out.println("Flow text not supported in SDK");

        System.out.println("Flow text supported in SDK");
        ...
        ss.setSpan(new LeadingMarginSpan2Impl(lines, width), 0, ss.length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
