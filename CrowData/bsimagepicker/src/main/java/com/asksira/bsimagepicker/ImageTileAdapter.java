...
//            } else
              {
                itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        File thisFile = imageList.get(getAdapterPosition()- nonListItemCount);
                        System.out.println("Image tile selected "+  getAdapterPosition()+" "+thisFile.getName());
        ...
        public void bind (int position) {
            System.out.println("Bind for position "+position);
            ...
            System.out.println(selectedFiles.contains(imageFile));
